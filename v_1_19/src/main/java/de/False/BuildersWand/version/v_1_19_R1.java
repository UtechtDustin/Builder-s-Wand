...
public class v_1_19_R1 implements de.False.BuildersWand.version.NMS
{
    private JavaPlugin plugin;
    private Random random;

    public v_1_19_R1(JavaPlugin plugin)
    {
        this.plugin = plugin;
    ...
    public String getTag(ItemStack itemStack, String path)
    {
        ...
        net.minecraft.world.item.ItemStack nmsStack = org.bukkit.craftbukkit.v1_19_R1.inventory.CraftItemStack.asNMSCopy(itemStack);
        CompoundTag compound = nmsStack.getTag();
        if (compound == null) {
            compound = new CompoundTag();
            nmsStack.setTag(compound);
